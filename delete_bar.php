...
if(isset($_POST['submit'])) {
	$sql = "DELETE FROM kroeg WHERE kroegcode = '$barCode'";
	$res = mysqli_query($conn, $sql);
}
...
<head>
  ...
  <title>BierKiezer - <?php echo uppercase($barName); ?> - Verwijderen</title>
...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <table class="table-striped col-md-12">
					<tr>
						<th colspan="2"><h3 class="col-sm-offset-1 col-sm-10"><?php echo $barName; ?> - Verwijderen</h3></th>
					</tr>
          <tr>
      ...
      <hr>
			<div class="row">
				<?php if(!isset($_POST['submit'])) { ?>
					<div class="col-md-8">
						<h4>Weet u zeker dat u deze kroeg wilt verwijderen?</h4>
					</div>
					<div class="col-md-2">
						<form action="delete_bar.php?bid=<?php echo $barCode; ?>" method="post">
				...
				<?php } else { ?>
					<div class="col-md-offset-1 col-md-9">
						<h4><?php echo $barName; ?> is definitief verwijderd.</h4>
					</div>
					<div class="col-md-2">
						<form action="own_data.php">
							<input type="submit" class="form-control" name="submit" value="Terug">
