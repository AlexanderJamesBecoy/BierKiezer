...
if(isset($_POST['submit'])) {
		$barName = $_POST['naam'];
		$barAddress = $_POST['adres'];
		$barPlace = $_POST['plaats'];

		$sql = "INSERT INTO kroeg (naam, adres, plaats, gebruikerscode) VALUES ('$barName','$barAddress','$barPlace','$userSelf')";
		$res = mysqli_query($conn, $sql);

		$sql = "SELECT kroegcode FROM kroeg WHERE naam = '$barName' AND adres = '$barAddress' AND plaats = '$barPlace' AND gebruikerscode = '$userSelf'";
		$res = mysqli_query($conn, $sql);
		$row = mysqli_fetch_array($res);
		$barCode = $row['kroegcode'];
		$comment = "Uw kroeg is toegevoegd";
}
    ...
    <div class="col-md-6">
      <div class="row">
				<?php if(!isset($_POST['submit'])) { ?>
					<form action="add_bar.php" method="post">
		        <table class="table-striped col-md-12">
							<tr>
								<th colspan="2"><h3 class="col-sm-offset-1 col-sm-10">Nieuwe kroeg toevoegen</h3></th>
							</tr>
		          <tr>
		          ...
		          <tr>
		            ...
		            <td><input type="text" class="form-control" name="adres" placeholder="Adres"></td>
		          </tr>
		          <tr>
		            <td><h4 class="col-sm-offset-2">Plaats</h4></td>
		            <td><input type="text" class="form-control" name="plaats" placeholder="Plaats"></td>
		          </tr>
							<tr>
	          ...
	          <tr>
	            <td><h4 class="col-sm-offset-2">Naam</h4></td>
							<td><h4><?php echo $barName; ?></h4></td>
	          </tr>
						<tr>
	            <td><h4 class="col-sm-offset-2">ID</h4></td>
							<td><h4><?php echo $barCode; ?></h4></td>
	          </tr>
						<tr>
	            <td><h4 class="col-sm-offset-2">Adres</h4></td>
							<td><h4><?php echo $barAddress; ?></h4></td>
	          </tr>
	          <tr>
	            <td><h4 class="col-sm-offset-2">Plaats</h4></td>
	            <td><h4><?php echo $barPlace; ?></h4></td>
	          </tr>
						<tr>
							<td><h4 class="col-sm-offset-2">Uw bier is toegevoegd!</h4></td>
							<td>
								<a href="view_bar.php?bid=<?php echo $barCode; ?>" class="dataAnchor">
