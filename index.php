...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-offset-1 col-md-10">
      <?php
      if(isset($_GET['went_premium'])) {
        echo "<marquee>U ging met succes naar premium! Bekijk 'data bekijken' onder uw naam aan de navigation bar.</marquee>";
      }
      ?>
    </div>
  </div>
  <div class="row">
    <div class="col-md-offset-1 col-md-10">
      <h3 class="col-md-offset-3">Nieuwste bier</h3>
      <?php
      $sql = "SELECT * FROM bier ORDER BY biercode DESC LIMIT 3";
  ...
  <div class="row">
    <div class="col-md-offset-1 col-md-10">
      <h3 class="col-md-offset-3">Nieuwste kroeg</h3>
      <?php
      $sql = "SELECT * FROM kroeg ORDER BY kroegcode DESC LIMIT 3";
      $res = mysqli_query($conn, $sql);
  ...
  <div class="row">
    <div class="col-md-offset-1 col-md-10">
      <h3 class="col-md-offset-3">Nieuwste kroeg</h3>
      <?php
      $sql = "SELECT * FROM brouwer ORDER BY brouwcode DESC LIMIT 3";
      $res = mysqli_query($conn, $sql);
