...
if(isset($_POST['submit'])) {
	$sql = "DELETE FROM brouwer WHERE brouwcode = '$brewCode'";
	$res = mysqli_query($conn, $sql);
}
...
<head>
  ...
  <title>BierKiezer - <?php echo uppercase($brewName); ?> - Verwijderen</title>
...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <table class="table-striped col-md-12">
					<tr>
						<th colspan="2"><h3 class="col-sm-offset-1 col-sm-10"><?php echo $brewName; ?> - Verwijderen</h3></th>
					</tr>
          <tr>
      ...
      <hr>
			<div class="row">
				<?php if(!isset($_POST['submit'])) { ?>
					<div class="col-md-8">
						<h4>Weet u zeker dat u deze brouwer wilt verwijderen?</h4>
					</div>
					<div class="col-md-2">
						<form action="delete_brewery.php?bid=<?php echo $brewCode; ?>" method="post">
				...
				<?php } else { ?>
					<div class="col-md-offset-1 col-md-9">
						<h4><?php echo $brewName; ?> is definitief verwijderd.</h4>
					</div>
					<div class="col-md-2">
						<form action="own_data.php">
							<input type="submit" class="form-control" name="submit" value="Terug">
